...
#pragma once
#ifndef  _BORDERTYPE_H_
#define  _BORDERTYPE_H_
...
namespace OWPML {
    ...
    // CBorderType Declaration 
    class CBorderType : public CExtObject
    {
    private:
        CBorderType(UINT id);
    public:
        virtual ~CBorderType();
        static CBorderType* Create();
        static CBorderType* CreateArg(UINT id);
