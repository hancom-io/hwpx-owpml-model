...
namespace OWPML {
    ...
    CSpacing* CSpacing::Create()
    {
        return new CSpacing();
    }

    CSpacing::CSpacing() : CExtObject(ID_HEAD_Spacing), m_nHangul(0), m_nLatin(0), m_nHanja(0), m_nJapanese(0), m_nOther(0), m_nSymbol(0), m_nUser(0)
    {
    }
    ...
    void CSpacing::InitMap(bool /*bRead*/)
    {
    }

    bool CSpacing::WriteElement(LPCWSTR pCurObjName, CSerializer* serialize, CAttribute* att)
    {
    ...
    bool CSpacing::ReadAttribute(CAttribute* att)
    {
        bool bres = TRUE;
