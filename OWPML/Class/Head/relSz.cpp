...
namespace OWPML {
    ...
    CRelSz* CRelSz::Create()
    {
        return new CRelSz();
    }

    CRelSz::CRelSz() : CExtObject(ID_HEAD_RelSz), m_uHangul(100), m_uLatin(100), m_uHanja(100), m_uJapanese(100), m_uOther(100), m_uSymbol(100), m_uUser(100)
    {
    }
    ...
    void CRelSz::InitMap(bool /*bRead*/)
    {
    }

    bool CRelSz::WriteElement(LPCWSTR pCurObjName, CSerializer* serialize, CAttribute* att)
    {
    ...
    bool CRelSz::ReadAttribute(CAttribute* att)
    {
        bool bres = TRUE;
