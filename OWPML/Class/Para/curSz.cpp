...
namespace OWPML {
    ...
    CCurSz::CCurSz() : CExtObject(ID_PARA_CurSz), m_uWidth(0), m_uHeight(0)
    {
    }
    ...
    void CCurSz::InitMap(bool /*bRead*/)
    {
    }

    bool CCurSz::WriteElement(LPCWSTR pCurObjName, CSerializer* serialize, CAttribute* att)
    {
    ...
    bool CCurSz::ReadAttribute(CAttribute* att)
    {
        bool bres = TRUE;
