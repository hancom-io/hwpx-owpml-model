...
namespace OWPML {
    ...
    COrgSz::COrgSz() : CExtObject(ID_PARA_OrgSz), m_uWidth(0), m_uHeight(0)
    {
    }
    ...
    void COrgSz::InitMap(bool /*bRead*/)
    {
    }

    bool COrgSz::WriteElement(LPCWSTR pCurObjName, CSerializer* serialize, CAttribute* att)
    {
    ...
    bool COrgSz::ReadAttribute(CAttribute* att)
    {
        bool bres = TRUE;
