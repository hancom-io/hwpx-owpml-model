...
#pragma once
#ifndef  _SHADOWTYPE_H_
#define  _SHADOWTYPE_H_
...
namespace OWPML {
    ...
    // CShadowType Declaration 
    class CShadowType : public CExtObject
    {
    private:
        CShadowType();
    public:
        virtual ~CShadowType();
        static CShadowType* Create();
    ...
    public:
        ...
        SHADOWTYPE GetType(void) { return (SHADOWTYPE)m_uType; }
        void SetType(SHADOWTYPE type) { m_uType = (UINT)type; }
