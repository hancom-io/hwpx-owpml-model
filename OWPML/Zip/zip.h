...
namespace OWPML {
     ...
     * 2. add parameter of function to adapt secure function
	 */
    ...
    typedef struct zlist {
        ...
        ulg atx, off;
        TCHAR name[MAX_PATH];          // File name in zip file
    ...
    ZRESULT ZipAddUnCompress(HZIP hz, const TCHAR *dstzn, const TCHAR *fn, CEncryptInfo* pencryptinfo = NULL);
    ZRESULT ZipAddUnCompress(HZIP hz, const TCHAR *dstzn, void *src, unsigned int len, CEncryptInfo* pencryptinfo = NULL);
    ZRESULT ZipAdd(HZIP hz, const TCHAR *dstzn, const TCHAR *fn, CEncryptInfo* pencryptinfo = NULL);
    ZRESULT ZipAdd(HZIP hz, const TCHAR *dstzn, void *src, unsigned int len, CEncryptInfo* pencryptinfo = NULL);
    ZRESULT ZipAddHandle(HZIP hz, const TCHAR *dstzn, HANDLE h, CEncryptInfo* pencryptinfo = NULL);
    ZRESULT ZipAddHandle(HZIP hz, const TCHAR *dstzn, HANDLE h, unsigned int len, CEncryptInfo* pencryptinfo = NULL);
    ZRESULT ZipAddFolder(HZIP hz, const TCHAR *dstzn, CEncryptInfo* pencryptinfo = NULL);
...
#define ZR_STORE 0                 // Store method
#define ZR_DEFLATE 8               // Deflation method
