...
namespace OWPML {
    ...
    // GetUnZipItemInfo - call this to get information about an item in the zip.
    ...
    // is not possible and GetUnZipItemInfo(-1) fails and you can't discover the number
    // of items except by calling GetUnZipItemInfo on each one of them in turn,
    ...
    ZRESULT GetUnzipItem(HZIP hz, int index, const TCHAR *fn);
    ZRESULT GetUnzipItem(HZIP hz, int index, void *z, unsigned int len, int& decompress);

    ZRESULT UnzipItem(HZIP hz, int index, const TCHAR *fn);
    ZRESULT UnzipItem(HZIP hz, int index, void *z, unsigned int len);
    ZRESULT UnzipItem(HZIP hz, int index, void *z, unsigned int len, int& decompress);
